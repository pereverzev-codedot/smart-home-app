...
import {LogoutIcon, SettingsIcon, ThemeIcon} from "../../images";
		...
		<div className={`right-bar ${open && "active"}`}>
			...
			<div className="right-bar-section">
				...
				<div className="right-bar-bottom-bar">
					<div className="bottom-bar_element" onClick={handlerChangeTheme} tabIndex={0} role="button"><img src={ThemeIcon} alt="theme"/></div>
