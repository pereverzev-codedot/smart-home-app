...
const changableSchema = new Schema(
	{
		...
		firstFloorLight: {value: Number, key: String, title: String},
		secondFloorLight: {value: Number, key: String, title: String},
		garageLight: {value: Number, key: String, title: String},
		outsideLight: {value: Number, key: String, title: String},
